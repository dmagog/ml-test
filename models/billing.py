...
class Bill(SQLModel, table=True):
    ...
    FreeLimitToday: float # сколько обесплатных операций осталось на сегодня
    FreeLimitPerDay: float # сколько обесплатных операций в день доступно в принципе
...
#             else:
#                 Operation = 'Недостаточно средеств на счете' 
